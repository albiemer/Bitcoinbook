...
# 1 |i import specifically the function rather than to use "import *" to make-
# 1 |the program little bit increase its running and that's why its convinient-
# 1 |for me because i use 32bit architecture processor but if you use flagship-
# 1 |computer with high processor, you can use "import *".
from note import title, clrscr, opthead, nofoundrecordnote, foundrecordnote, \
     noteonly, entryinvalid

# |1| find above description
...
def insertrecord(*insert):
    sqlqueryinsertrecord(insert[0], insert[1], insert[2], insert[3], insert[4], \
                         insert[5], insert[6])
    printlastrecord()
